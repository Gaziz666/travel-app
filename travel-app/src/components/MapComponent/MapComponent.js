...
import ReactMapboxGL, { Marker, FullscreenControl, Layer, Feature, Source } from '@urbica/react-map-gl';
...
const MapComponent: React.FC<Props> = ({ countriesLoaded, selectedCountryIndex, countries, selectedLanguage }) => {
    ...
    let latitudeCapital = '41.8919';
    let longitudeCapital = '12.5113';

    // if (countries.length > 0) {
    //     latitudeCapital = countries[selectedCountryIndex].coordinate.x;
    //     longitudeCapital = countries[selectedCountryIndex].coordinate.y;
    // }
            ...
            >
                <Marker latitude={latitudeCapital} longitude={longitudeCapital}>
                    <div className={classes.marker__btn}>
                        <img src="../../assets/images/marker_icon.svg" alt="capital" />
                    </div>

                </Marker>
                <FullscreenControl position='top-right' />
                <Source id="Turkey" type="geojson" data={geojson}>
                    <Layer
                        id='anything'
                        type='fill'
                        paint={{
